...
public class ServiceHistoryBinder extends ViewBinder<ServiceHistoryEnt> {
    ...
    public ServiceHistoryBinder(DockActivity dockActivity, BasePreferenceHelper prefHelper, RecyclerViewItemListener clickListner, boolean isCompleted) {
    ...
    public void bindView(final ServiceHistoryEnt entity, final int position, int grpPosition, View view, Activity activity) {
        ...
        if(entity!=null) {
            ...
            if (entity.getReceiverDetail() != null && entity.getReceiverDetail().getUserName() != null)
        ...
        if (entity.getStatus()!=null && entity.getStatus().equals(AppConstants.accepted)) {
        ...
        } else if (entity.getStatus()!=null && entity.getStatus().equals(AppConstants.pending)) {
        ...
        if (entity.getIsRate() != null && isCompleted && entity.getIsRate().equals("0") && entity.getStatus().equals(AppConstants.completed)) {
        ...
        viewHolder.btnRate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                clickListner.onCategoryClick(entity, position);
            }
        });
