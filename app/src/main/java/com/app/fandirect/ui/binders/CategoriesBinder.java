...
/**
 * Created by saeedhyder on 5/3/2018.
 */

public class CategoriesBinder extends RecyclerViewBinder<Result> {

    private ImageLoader imageLoader;
    private RecyclerViewItemListener recyclerViewItemListener;

    public CategoriesBinder(RecyclerViewItemListener recyclerViewItemListener) {
    ...
    public void bindView(final Result entity, final int position, Object viewHolder, Context context) {
        ...
        holder.serviceType.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                recyclerViewItemListener.onCategoryClick(entity, position);
            }
        });
    }
