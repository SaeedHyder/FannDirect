...
public class FeedsRecyclerBinder extends RecyclerViewBinder<Post> {
    ...
    public FeedsRecyclerBinder(Context dockActivity, BasePreferenceHelper prefHelper, RecyclerViewItemListener clickListner, PostClicksInterface postClicksInterface, ReportPostIntetface reportPostIntetface) {
    ...
    @Override
    public void bindView(final Post entity, final int position, Object holder, Context context) {
        ...
        viewHolder.ivImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (entity.getUserDetail().getRoleId().equals(UserRoleId)) {
                    ((DockActivity) dockActivity).replaceDockableFragment(UserProfileFragment.newInstance(entity.getUserDetail().getId() + ""), "UserProfileFragment");
                } else {
                    ((DockActivity) dockActivity).replaceDockableFragment(SpProfileFragment.newInstance(entity.getUserDetail().getId() + ""), "SpProfileFragment");
                }
            }
        });
        ...
        viewHolder.llLikeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (entity.getLikeCount() > 0) {
                    ((DockActivity) dockActivity).addDockableFragment(LikePostFragment.newInstance(entity.getId() + ""), "LikePostFragment");
                }
            }
        });
