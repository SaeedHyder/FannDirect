...
public class PromotionsBinder extends ViewBinder<Post> {
    ...
    public PromotionsBinder(DockActivity dockActivity, BasePreferenceHelper prefHelper, RecyclerViewItemListener clickListner,PostClicksInterface postClicksInterface) {
